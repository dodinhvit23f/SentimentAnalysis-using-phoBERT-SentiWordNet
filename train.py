...
parser.add_argument('--train_path', type=str, default='./data/train_all_new.csv')
#parser.add_argument('--train_path', type=str, default='./data/train_VLSP.csv')
...
for  fold, (train_idx, val_idx) in enumerate(splits):
    ...
    for epoch in tq:
        ...
        for i,(x_batch, y_batch, senti1_batch) in pbar:
            ...
            y_pred = model_bert(x_batch.cuda(), senti1_batch.cuda(), attention_mask=(x_batch>0).cuda())
...
test_path = "./data/test_VLSP_2_labels.csv"
...
f=open("results_test_VLSP_2_labels_MLP14.txt", "w")
f.write("test_VLSP_2_labels using MLP \n")
