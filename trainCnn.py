...
# Thay đổi mới ở đây sẽ chỉ chứa data sau đó theo batch chuyển sang dạng của
...
X_test = convert_lines_cnn(test_df, vocab, bpe,1000) # chuyen X_train thành ma tran, moi dòng là danh sach các id
